...
def main():
    ...
    # 1a: Create Catagory dictionaries of all words minus punctuation and stuff 
    # 1b: write to new set of files
    # 2: read in dictionary
    # 3: Clean out anoying words
    # 3a: create baggies
    # 
    ...
    catagoryCount = 0
    for catagory in Path(file_path).iterdir():
    ...
    #writeDictionaryOutFile = "C:/Users/djnvk/Desktop/Project2/bagOfWords/bagOfWords/20GroupsDictionary/dict_" + file.name

    

    #sortedDict = dict(sorted(listOfDictionaries[1].dictionary.items(),key= lambda x:x[1]))
    #print(sortedDict)

    #print(f"Number of words: {len(sortedDict)}")
